...
//Thisi page displays the details for a particular print.
...
if(isset($_GET['pid']) && filter_var($_GET['pid']), FILTER_VALIDATE_INT, array('min_range' => 1))
{
	...
	//Connect to database
	$q= "SELECT CONCAT_WS(' ', first_name, middle_name, last_name) AS artist, print_name, price, description, size, image_name FROM artists, prints WHERE artists.artist_id=prints.artist_id=$pid";
