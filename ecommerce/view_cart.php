...
if (!empty($_SESSION['cart']))
{
	...
	echo "<tr>";
	echo "<td align = 'left' width = '30%'><b>Artist</b></td>";
	echo "<td align = 'left' width = '30%'<b>Print Name</b></td>";
	echo "<td align = 'right' width = '10%'<b>Price</b></td>";
	echo "<td align = 'center' width = '10%'<b>Qty</b></td>";
	echo "<td align = 'right' width = '10%'<b>Total Price</b></td>";
	echo "</tr>";
	...
	while ($row = mysqli_fetch_array ($r, MYSQLI_ASSOC))
	{
		...
		echo "<td align =\'left\'>{$row['print_name']}</td>";
		echo "<td align =\'right\'>\${$_SESSION['cart'][$row['print_id']]['price']}</td>";
		echo "<td align =\'center\'><input type =\'text\' size = \'3\' name =\'qty[{$row['print_id']}]\'
	...
	echo "</tr>";
	echo "</table>";
	echo "<div align='center'><input type='submit' value = 'Update My Cart' /></div>";
	echo "</form><p align = 'center'> Enter a quantity of 0 to remove an item.";
	echo "<br /><br /><a href='checkout.php'>Checkout</a></p>";
} else
{
